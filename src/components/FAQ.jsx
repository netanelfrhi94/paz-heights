...
const items = [
  ...
  { q: 'האם יש אחריות?',                    a: 'כן. כל פרויקט מסופק עם אחריות מלאה בכתב — 12 חודשים על העבודה. אם משהו לא תקין — אנחנו חוזרים, על חשבוננו.' },
  { q: 'האם עובדים עם פנל מבודד איכותי?',  a: 'אנחנו עובדים עם חומרים איכותיים ומתקדמים בהתאם לדרישות הפרויקט ולבקשת הלקוח. הצעת המחיר תכלול מפרט מדויק של כל החומרים.' },
