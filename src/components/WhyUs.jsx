...
const items = [
  ...
  { n: '02', t: 'לוח זמנים מחייב',     d: 'מחויבים לתאריך המסירה. אם חורגים בלי סיבה מוצדקת — קנס יומי בכתב על חשבוננו. לא הבטחה — חוזה.'         },
  { n: '03', t: 'חומרים פרימיום',       d: 'פנל מבודד איכותי, פרזול גרמני, חיבורים תקניים. עובדים רק עם ספקים מאושרים ומוכחים — בלי פשרות.'         },
  { n: '04', t: 'מדברים עם הבעלים',    d: 'לא קבלן משנה, לא מתווך, לא מוקד שירות. שלושה אחים מילואימניקים — זמינים אישית לכל לקוח, לכל שאלה.'    },
